...
class CuentaYPagosTests(TestCase):
    def setUp(self):
        ...
        self.plato = Plato.objects.create(nombre="Plato", precio=Decimal("12000.50"))
        self.otro_plato = Plato.objects.create(nombre="Otro plato", precio=Decimal("9000.00"))
...
class CarreraPagosYCierreTests(TransactionTestCase):
    def setUp(self):
        ...
        self.plato = Plato.objects.create(nombre="Plato", precio=Decimal("10.25"))
